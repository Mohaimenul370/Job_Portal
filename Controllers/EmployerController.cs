...
namespace JP2.Controllers
{
    ...
    public class EmployerController : Controller
    {
        ...
        public EmployerController(ApplicationDbContext context, IHttpContextAccessor contextAccessor)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Id,CompanyName,CompanyDescription,CompanyWebsite")] Employer employer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CompanyName,CompanyDescription,CompanyWebsite")] Employer employer)
        {
            if (id != employer.Id)
            {
                return NotFound();
